...
public class MyBankActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivBankLogo = (ImageView) findViewById(R.id.ivBankLogo);		
		tvUserName = (TextView) findViewById(R.id.tvUserName);		
		etUserName = (EditText) findViewById(R.id.etUserName);		
		tvPassword = (TextView) findViewById(R.id.tvPassword);		
		etPassword = (EditText) findViewById(R.id.etPassword);		
		btLogin = (Button) findViewById(R.id.btLogin);;		
		btForgotPwd = (Button) findViewById(R.id.btForgotPwd);
	...
	public void onForgotPwdClick(View view) {
		Toast.makeText(this, "Start Forgot Password Activity", Toast.LENGTH_SHORT).show();
