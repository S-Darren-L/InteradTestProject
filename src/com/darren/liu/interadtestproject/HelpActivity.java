...
public class HelpActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//load bank web page
		wvBankWeb = (WebView) findViewById(R.id.wvBankWeb);
		wvBankWeb.getSettings().setJavaScriptEnabled(true);
		final Activity activity = this;

		wvBankWeb.setWebViewClient(new WebViewClient() {
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(activity, description, Toast.LENGTH_SHORT).show();
            }
        });

        wvBankWeb.loadUrl("http://www.rbcroyalbank.com/mobile/personal/index.html");
